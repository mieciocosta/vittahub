...
- **Distribuição de leads (28/08)**: conversa SEM responsável só aparece pro master e pra quem tem `usuarios.distribuidor` (Danielle) — e só se teve mensagem nos últimos 7 dias (o passado, ~1.900 conversas, fica fora da fila). A entrega é MANUAL, por ordem do master: o sistema não distribui sozinho, só avisa. Aba "📥 Distribuição" com botões de um toque (iniciais da equipe) + "💬 Meus atendimentos".
