...
- **Mayara assume a Fidelidade (23/09)**: `seed_mayara_fidelidade_v1` copia o perfil da Poliana pra Mayara (setor vacinas, `so_fidelidade`, metas, regras, IA) e passa toda conversa/lead da pasta Fidelidade e tudo no nome da Poliana pra ela (lista pra desfazer em `configuracoes.fidelidade_mayara_undo`). As regras por nome (`carteiraFechadaDe`, `soFidelidadeDe`, `carteiraFechada`) incluem `mayara`. Poliana não foi mexida.
