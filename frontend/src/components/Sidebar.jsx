...
export default function Sidebar({ unread = 0, theme = 'light', onToggleTheme, collapsed = false, onToggleCollapse, mobileOpen = false, onCloseMobile, corDia = 'auto', onSetCorDia, paletaCores = [] }) {
  ...
  const FRASES_VENDA = [
    'Enquanto você pensa em vender, a mãe só quer alguém que resolva. Seja você.',
    'Responda em 1 minuto e a concorrência nem fica sabendo.',
    'Hoje alguém vai escolher a Vittalis por SUA causa.',
    'Meta não é pressão. É direção.',
    'O "sim" mora duas perguntas depois do "não".',
    'Venda de manhã. À tarde, venda de novo.',
    'Ninguém esquece quem cuidou bem do seu filho.',
    'Seu WhatsApp é um balcão: nunca deixe ninguém esperando nele.',
    'Fechou um? Aproveita o embalo — o segundo vem mais fácil.',
    'Preço a cliente esquece. Descaso, nunca.',
    'Quem conhece o nome do bebê já saiu na frente.',
    'Orçamento parado é dinheiro alheio.',
    'Não conte os leads. Faça os leads contarem com você.',
    'Cada "vou pensar" precisa de um dia e hora pra voltar.',
    'A agenda de amanhã se enche com as ligações de hoje.',
    'Fale de proteção, não de picada.',
    'Vender bem é tirar o medo, não o dinheiro.',
    'A fila do ranking anda — pra frente ou pra trás.',
    'Um follow-up educado nunca perdeu cliente. O silêncio, sempre.',
    'O melhor argumento é a pergunta certa.',
    'Cliente quente esfria em horas. Aja em minutos.',
    'Sua meta do dia cabe numa única boa conversa.',
    'Segunda-feira é onde o campeão do mês nasce.',
    'Escuta de verdade: a mãe conta como quer ser convencida.',
    'Vacina em dia é a mãe dormindo tranquila. Venda isso.',
    'O concorrente responde amanhã. Você, agora.',
    'Não existe cliente difícil. Existe história mal ouvida.',
    'Fecha a boca depois da pergunta de fechamento. Quem fala primeiro, cede.',
    'Grandes meses são feitos de terças-feiras comuns.',
    'A dose que você agenda hoje é a criança protegida amanhã.',
    'Todo recorde começou como um dia normal.',
    'Cansaço passa. Meta batida fica.',
    'Um cliente fidelidade vale um ano de trabalho — trate como ouro.',
    'Quem manda áudio atencioso fecha mais que quem manda tabela.',
    'A objeção é o cliente pedindo ajuda pra dizer sim.',
    'Não deixe pra sexta a venda que pode fechar hoje.',
    'Confirmar a consulta de amanhã é vender duas vezes.',
    'O cliente sumido só precisa de um bom motivo pra voltar. Dê um.',
    'Menos "oi, tudo bem?", mais "consegui um horário pra você".',
    'Sua voz calma vende mais que qualquer promoção.',
    'Plano fechado é família cuidada o ano inteiro.',
    'Não venda pra bater meta. Bata a meta porque vendeu certo.',
    'Cada carteira tem um tesouro esquecido. Garimpe a sua.',
    'Atendimento morno gera resposta fria.',
    'Quem domina o esquema vacinal nunca fica sem resposta.',
    'Pergunta de campeã: "o que falta pra gente marcar?"',
    'Desconto convence por um dia. Confiança, por anos.',
    'A primeira mensagem do dia define seu ritmo. Capricha nela.',
    'Se o cliente respondeu, a venda está viva.',
    'Fechamento não é sorte: é a soma dos detalhes que você cuidou.',
    'Trabalhe a lista de aniversariantes: carinho que fatura.',
    'Todo mundo vende quando é fácil. Você vende sempre.',
    'O não de hoje é o retorno agendado de amanhã.',
    'Cliente indicado chega meio fechado. Termine o serviço.',
    'Sua concorrente de verdade é a distração da mãe. Seja inesquecível.',
    'Falar preço sem falar valor é jogar a venda fora.',
    'Um "como o bebê está?" abre mais portas que qualquer oferta.',
    'A venda mais lucrativa é a que volta todo mês.',
    'Quando bater a preguiça, lembra: alguém está esperando sua mensagem.',
    'Explique como pra uma amiga, feche como profissional.',
    'A meta assusta de longe. De perto, é só o dia bem feito.',
    'Retorno marcado é promessa — cumpra no horário.',
    'Deixe o cliente falar até ele se convencer sozinho.',
    'O placar não mente: quem semeia conversa, colhe venda.',
    'Cinco minutos de atenção valem mais que 5% de desconto.',
    'Não durma com orçamento sem resposta na sua fila.',
    'Vender saúde é o único comercial que salva vidas.',
    'Pediu indicação hoje? O satisfeito indica fácil — se você pedir.',
    'Cada tela do sistema é um cliente esperando um passo seu.',
    'Ligação de 3 minutos resolve o que 30 mensagens não resolvem.',
    'Se você não lembrar da dose do cliente, ninguém lembra.',
    'Comemore alto a venda da colega — a próxima pode ser sua.',
    'O campeão do mês perde vendas também. Só não perde o ânimo.',
    'Fale com 10 hoje e o mês se resolve sozinho.',
    'Cortesia custa zero e rende juros.',
    'A pressa é sua aliada só na resposta. Na conversa, calma.',
    'Quem organiza a carteira nunca começa o mês do zero.',
    'Mostre a data livre: "tenho quinta às 9h" fecha mais que "quando quiser".',
    'Cliente confuso não compra. Simplifique.',
    'Seu melhor dia de vendas começou igual a hoje.',
    'Não é insistência quando é cuidado.',
    'A família confia em quem chega antes da dúvida.',
    'Todo lead frio já foi quente. Reacenda.',
    'Se está difícil vender, volte a perguntar. Sempre funciona.',
    'Feche o dia sem nenhum cliente no vácuo. É sua marca.',
    'O prêmio do mês se ganha em parcelas diárias.',
    'Sua meta agradece cada "só confirmando nosso horário".',
    'Mais vale um cliente bem cuidado que dez mal atendidos.',
    'Bebê que nasce no bairro é cliente que a Vittalis ainda não conheceu.',
    'Um bom resumo no fim da conversa amarra a venda.',
    'Responda a objeção com história real: "uma mãe aqui semana passada..."',
    'O sistema mostra quem precisa de você. Olhe o painel e vá.',
    'Nunca subestime uma segunda tentativa educada.',
    'Vitrine é seu perfil, atendimento é sua fama.',
    'Meta global é a soma de "mais um hoje".',
    'Quem cuida do pós-venda nunca precisa caçar cliente novo.',
    'Você não interrompe a mãe: você chega na hora certa da dúvida dela.',
    'Amanhã cedo, seja a primeira notificação boa do cliente.',
    'Termine hoje melhor que ontem. É só isso, todo dia.',
    'A Vittalis cresce uma conversa por vez — e a próxima é sua.',
  ];
