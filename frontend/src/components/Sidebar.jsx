...
export default function Sidebar({ unread = 0, theme = 'light', onToggleTheme, collapsed = false, onToggleCollapse, mobileOpen = false, onCloseMobile, corDia = 'auto', onSetCorDia, paletaCores = [] }) {
  ...
  const FRASES_VENDA = [
    ...
    'Quem chega primeiro no cliente chega primeiro no sim.',
    'Mensagem sem resposta é venda escapando.',
    'Venda começa quando o cliente diz não.',
    'Preço se esquece; cuidado, nunca.',
    'Agenda cheia é consequência de conversa bem feita.',
    'Não empurre: conduza.',
    'Pergunta boa vale mais que argumento bonito.',
    'O cliente compra segurança, não seringa.',
    'Detalhe que você explica é objeção que morre.',
    'Fechar é ajudar a decidir.',
    'Quem domina o produto não teme pergunta.',
    'Silêncio do cliente é convite pro follow-up.',
    'Venda perdida ensina; venda ignorada, não.',
    'Cada "depois eu vejo" merece uma data marcada.',
    'Confiança se constrói na primeira resposta.',
    'Hoje é o dia que você prometeu ontem.',
    'Meta não se olha, se caça.',
    'Cliente bem atendido volta com o irmão.',
    'A pressa em responder é o seu diferencial.',
    'Orçamento sem retorno é dinheiro no vento.',
    'Venda o próximo passo, não o produto inteiro.',
    'Cordialidade fecha porta pra concorrência.',
    'Quem cuida da carteira não precisa de sorte.',
    'Um lembrete gentil vale um cliente de volta.',
    'Seja a resposta mais rápida da cidade.',
    'Entusiasmo é contagioso — use o seu.',
    'Objeção é interesse mal vestido.',
    'O topo do ranking se decide nas segundas-feiras.',
    'Fale menos de preço, mais de proteção.',
    'Cada bebê protegido é a sua assinatura.',
    'Vender bem é explicar bem.',
    'Cliente esquecido é cliente do concorrente.',
    'Sua meta diária cabe em uma boa conversa.',
    'Comece pelo cliente mais difícil — o resto flui.',
    'Quem registra a venda garante o mérito.',
    'Combinado claro, cliente que retorna.',
    'A segunda tentativa fecha o que a primeira abriu.',
    'Não julgue o bolso do cliente: apresente e deixe-o escolher.',
    'Agilidade é gentileza.',
    'Toda família quer o melhor — mostre o caminho.',
    'Fechamento é detalhe quando a conversa foi boa.',
    'Plano vacinal: venda uma vez, cuide o ano todo.',
    'Sua voz é o cartão de visita da clínica.',
    'Quem acompanha o placar joga melhor.',
    'Metade da venda é lembrar de cobrar resposta.',
    'Grande mês é feito de dias comuns bem usados.',
    'O cliente não vê seu esforço — vê sua resposta.',
    'Datas de dose são oportunidades marcadas no calendário.',
    'Trabalhe a lista de sumidos: ouro esquecido.',
    'Uma boa pergunta abre mais que dez argumentos.',
    'Cuide do cliente pequeno: ele cresce.',
    'Vender é repetir o básico com excelência.',
    'Resposta curta e morna não fecha nada.',
    'Mostre a agenda: data marcada segura a decisão.',
    'Confirmação de véspera evita cadeira vazia.',
    'Cadeira vazia é meta adiada.',
    'Ligue quando todos só mandam mensagem.',
    'Seu humor não pode custar uma venda.',
    'Comemore cada fechamento — energia chama energia.',
    'Aprenda com a colega que fechou hoje.',
    'Não existe lead frio, existe abordagem morna.',
    'O impossível de sexta se resolve na segunda de manhã.',
    'Quem conhece o histórico da família vende no primeiro toque.',
    'Falar o nome do bebê vale mais que dar desconto.',
    'Desconto é o último argumento, não o primeiro.',
    'Venda casada com carinho não tem devolução.',
    'A mãe lembra de quem lembrou dela.',
    'Todo dia tem alguém precisando exatamente do que você oferece.',
    'Organização é a irmã gêmea da venda.',
    'Termine o dia com a caixa de espera zerada.',
    'Melhor um "não" hoje que um "talvez" pra sempre.',
    'Sua constância é o seu marketing.',
    'Cliente indicado já vem meio convencido — não desperdice.',
    'Peça indicação no auge da satisfação.',
    'O relatório do dia conta a história que você escreveu.',
    'Amanhã agradece o follow-up que você fizer hoje.',
    'Bater a meta é bom; saber como bateu é melhor.',
    'Você não vende consulta: abre a porta da saúde.',
    'Fez o melhor pelo cliente? A venda é consequência.',
    'Cem clientes começam com um bom-dia bem dado.',
  ];
