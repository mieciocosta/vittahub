          ...
          {showProntas && sel && (() => {
            ...
            const GRUPOS_PRONTAS = [
              ...
              ['✅ Cartões de agendamento (preencha os campos)', [
                ['Vacina em casa', cartao(['✅ Confirmação da sua vacinação','',`📁 Cliente: ${nomeC}`,`👶🏻 Paciente: ${pac}`,'📅 Data: {DATA} {DIA DA SEMANA}','🕓 Horário: {HORA}hs','📍 Local: Em sua residência','📌 Serviço: Vacinas de {IDADE}','','Parabéns pelo investimento na saúde do seu Baby 🩵','',INSTA])],
                ['Vacina na clínica', cartao(['✅ Confirmação da sua vacinação','',`📁 Cliente: ${nomeC}`,`👶🏻 Paciente: ${pac}`,'📅 Data: {DATA} {DIA DA SEMANA}','🕓 Horário: {HORA}hs','📍 Local: Na Clínica Vittalis Saúde (Renascença)','📌 Serviço: Vacinas de {IDADE}','',ENDER,'','Parabéns pelo investimento na saúde do seu Baby 🩵','',INSTA])],
                ['Consulta na clínica', cartao(['✅ Confirmação da sua consulta','',`📁 Cliente: ${nomeC}`,`👶🏻 Paciente: ${pac}`,'📅 Data: {DATA} {DIA DA SEMANA}','🕓 Horário: {HORA}hs','👩‍⚕️ Profissional: {PROFISSIONAL} ({ESPECIALIDADE})','📍 Local: Na Clínica Vittalis Saúde (Renascença)','📌 Serviço: {SERVIÇO}','',ENDER,'','Parabéns pelo investimento na saúde do seu Baby 🩵','',INSTA])],
                ['Consulta em casa', cartao(['✅ Confirmação da sua consulta','',`📁 Cliente: ${nomeC}`,`👶🏻 Paciente: ${pac}`,'📅 Data: {DATA} {DIA DA SEMANA}','🕓 Horário: {HORA}hs','👩‍⚕️ Profissional: {PROFISSIONAL} ({ESPECIALIDADE})','📍 Local: Em sua residência','📌 Serviço: {SERVIÇO}','','Parabéns pelo investimento na saúde do seu Baby 🩵','',INSTA])],
              ]],
            ];
            return (
